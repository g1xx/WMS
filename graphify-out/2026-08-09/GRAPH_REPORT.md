...
## Corpus Check
- 159 files · ~40,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 893 nodes · 1474 edges · 78 communities (39 shown, 39 thin omitted)
...
Cohesion: 0.07
Nodes (32): ActionResult, Authorize, Guid, HttpGet, HttpPost, IActionResult, IEnumerable, Task (+24 more)
...
Cohesion: 0.07
Nodes (27): ActionResult, HttpPost, Task, InventoryController, ActionResult, DateTime, Guid, HttpGet (+19 more)
...
Cohesion: 0.10
Nodes (21): ActionResult, Guid, HttpPost, IActionResult, IdentityUser, Task, AuthController, ActionResult (+13 more)
...
Cohesion: 0.14
Nodes (7): ModelBuilder, ConfigureOrdersConstraints, ModelBuilder, AddContainersStock, ModelBuilder, AddPutaway, Warehouse.Infrastructure.Migrations
...
Cohesion: 0.24
Nodes (4): Warehouse.Api.Common, Warehouse.Api.DTOs, Warehouse.Api.Services, Warehouse.Application.Services
...
- **Why does `AppDbContext` connect `AppDbContext` to `PickTask API & Service`, `Products & Stocks API`, `Orders API & Allocation`, `Containers API & Mapping`, `Controller Namespace Hub`, `Auth Controller & Login`, `Locations Controller API`, `Order Service Layer`, `PickTask Entity Mapping`, `TestOrderGenerator/src/App.tsx`, `Snapshot: InitialCreate`, `AppDbContext`, `Container`, `PickTask`, `PutawayTask`, `PickTaskItem`, `Product`, `PutawayTaskItem`, `Stock`?**
