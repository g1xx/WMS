# Graph Report - WMS  (2026-08-05)

## Corpus Check
- 152 files · ~38,685 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 863 nodes · 1419 edges · 72 communities (37 shown, 35 thin omitted)
...
2. `Warehouse.Infrastructure.Migrations` - 37 edges
3. `Warehouse.Domain` - 32 edges
4. `Warehouse.Infrastructure` - 31 edges
...
Cohesion: 0.14
Nodes (7): ModelBuilder, InitialCreate, ModelBuilder, AddPiecePackageProduct, ModelBuilder, AddContainersStock, Warehouse.Infrastructure.Migrations
...
Cohesion: 0.08
Nodes (28): AllowAnonymous, Result, ResultErrorType, ActionResult, Guid, HttpGet, HttpPost, IActionResult (+20 more)
...
Cohesion: 0.06
Nodes (28): Mode, axiosClient, logout(), App(), extractErrorMessage(), getAvailableQuantity(), inputStyle, InventoryAdmin() (+20 more)

### Community 27 - "Migration: ProductVolumetrics1"
Cohesion: 0.50
Nodes (3): MigrationBuilder, AddProductVolumetrics1, Migration

### Community 36 - "Snapshot: InitialCreate"
Cohesion: 0.17
Nodes (7): Guid, OrderItem, EntityTypeBuilder, OrderItemConfiguration, EntityTypeBuilder, XminConcurrencyExtensions, Warehouse.Infrastructure.Configurations

### Community 38 - "Snapshot: PiecePackageProduct"
Cohesion: 0.24
Nodes (4): ModelBuilder, AddOrdersAndOrderItems, Warehouse.Infrastructure, Warehouse.Api.Services

### Community 41 - "Container"
Cohesion: 0.27
Nodes (8): Guid, ICollection, Container, ContainerStatus, ContainerType, EntityTypeBuilder, ContainerConfiguration, IEntityTypeConfiguration
...
## Knowledge Gaps
- **155 isolated node(s):** `SplitAndCloseDto`, `$schema`, `commandName`, `dotnetRunMessages`, `launchBrowser` (+150 more)
...
- **Why does `Warehouse.Infrastructure` connect `Snapshot: PiecePackageProduct` to `RegisterDto.cs`, `20260618193047_AddProductVolumetrics.Designer.cs`, `Migration: Reserved/Available Qty`, `20260801193412_AddOrderItemPendingReplenishment.Designer.cs`, `AppDbContext`, `20260801201234_Add1.Designer.cs`, `Snapshot: ProductVolumetrics`, `Controller Namespace Hub`, `20260804092556_AddPutawayTables.Designer.cs`, `Snapshot: ProductVolumetrics1`, `Stock`, `EF Model Snapshot`, `Snapshot: Reserved/Available Qty`, `.AllocateOrderAsync`, `Product & Stock Entities`, `20260624095509_AddIdentityTables.Designer.cs`, `Warehouse.Api.Common`, `20260624095509_AddIdentityTables.Designer.cs`?**
  _High betweenness centrality (0.188) - this node is a cross-community bridge._
- **Why does `Warehouse.Infrastructure.Migrations` connect `EF Model Snapshot` to `Product & Stock Entities`, `Product`, `DI Composition Root`, `Migration: InitialCreate`, `Migration: ProductVolumetrics`, `Migration: Locations & Containers`, `Migration: Orders & OrderItems`, `Migration: Orders Constraints`, `Migration: PickTasks & Items`, `Migration: PickTasks & Items 1`, `Migration: Identity Tables`, `Migration: Containers Stock`, `Migration: Reserved/Available Qty`, `AppDbContext`, `Snapshot: PiecePackageProduct`, `Snapshot: ProductVolumetrics`, `Snapshot: ProductVolumetrics1`, `PickTaskItem`, `Snapshot: Reserved/Available Qty`, `.AllocateOrderAsync`, `20260624095509_AddIdentityTables.Designer.cs`, `Add1`, `20260624095509_AddIdentityTables.Designer.cs`, `AddReservedAvailableQuantity`, `AddConcurrencyAndStockConstraints`, `RegisterDto.cs`, `20260618193047_AddProductVolumetrics.Designer.cs`, `DateTime`, `20260801193412_AddOrderItemPendingReplenishment.Designer.cs`, `20260801201234_Add1.Designer.cs`, `OrderAllocationService.cs`, `Stock`, `20260804092556_AddPutawayTables.Designer.cs`?**
